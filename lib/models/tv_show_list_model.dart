...
//
//     final tvShowList = tvShowListFromJson(jsonString);

import 'dart:convert';

List<TvShowList> tvShowListFromJson(String str) => List<TvShowList>.from(json.decode(str).map((x) => TvShowList.fromJson(x)));

String tvShowListToJson(List<TvShowList> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
